...
module.exports = {
	// Project Identity
	appName: 'instrumentInventors', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'instrumentinventors', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'instrumentInventors',
		author: 'satopin',
		license: 'UNLICENSED',
		link: 'UNLICENSED',
		version: pkg.version,
