...
const HostedProgram = () => (
  <>
    ...
    <Block title="hosted events">
      <HorizontalSlider url="wp/v2/agenda/?subcat=host&cat=event&_embed" />
    </Block>
    ...
    <Block title="residencies">
      <HorizontalSlider url="wp/v2/artist/?cat=resident&_embed" />
    </Block>
    <Block title="hosted programs and series" bg={true}>
      <HorizontalSlider url="wp/v2/project/?cat=curated_programs&subcat=host&_embed" />
    </Block>
  </>
);
